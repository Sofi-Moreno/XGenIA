...
public class ModificarMedicamento extends javax.swing.JFrame {
     ...
     */
    public ModificarMedicamento(Usuario usuarioActual,Map<String,MedicamentoNoRefrigerado> noRefrigerados,Map<String,MedicamentoRefrigerado> refrigerados) {
        initComponents();
    ...
    private void ingresarButtomMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ingresarButtomMouseClicked
        if(combo.getSelectedItem()!="Selecciona el Medicamento"){
            ...
            if(med_1!=null){
                Modificador ventana = new Modificador(usuarioActual,med_1,noRefrigerados,refrigerados);
                ventana.setVisible(true);
                this.setVisible(false);
            }else if(med_2!=null){
                Modificador ventana = new Modificador(usuarioActual,med_2,noRefrigerados,refrigerados);
                ventana.setVisible(true);
                this.setVisible(false);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarMedicamento(usuarioActual,noRefrigerados,refrigerados).setVisible(true);
            }
        });
    }
