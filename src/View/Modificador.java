...
public class Modificador extends javax.swing.JFrame {
     ...
     */
    public Modificador(Usuario usuarioActual,MedicamentoNoRefrigerado med1,Map<String,MedicamentoNoRefrigerado> noRefrigerados,Map<String,MedicamentoRefrigerado> refrigerados) {
        initComponents();
        ...
        this.med1 = med1;
        bol=false;
        codigoTxt.setText(med1.getCodigoMedicamento());
        nombreTxt.setText(med1.getNombreMedicamento());
        loteTxt.setText(med1.getNumeroLote());
        costoTxt.setText(String.valueOf(med1.getCostoMedicamento()));
        unidadesTxt.setText(String.valueOf(med1.getUnidadesExistentes()));
        unidadesTxt1.setText(String.valueOf(med1.getUnidadesVendidas()));
        vigenciaBox.setSelectedItem(med1.getVigenciaMedicamento());
        mesBox.setSelectedItem(med1.getFechaVencimiento().substring(5,6));
    }
    
    public Modificador(Usuario usuarioActual,MedicamentoRefrigerado med2,Map<String,MedicamentoNoRefrigerado> noRefrigerados,Map<String,MedicamentoRefrigerado> refrigerados) {
        initComponents();
        setIconImage(new ImageIcon(getClass().getResource("/Images/logo.png")).getImage());
        this.setResizable(false);
        this.noRefrigerados = noRefrigerados;
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ModificarMedicamento ventana = new ModificarMedicamento(usuarioActual,noRefrigerados,refrigerados);
...
//            Refrigerado ref = new Refrigerado(usuarioActual,medicamento);
//            ref.setVisible(true);
            this.setVisible(false);

        } else if (option == JOptionPane.NO_OPTION) {
//            NoRefrigerado ref = new NoRefrigerado(usuarioActual,medicamento);
//            ref.setVisible(true);
            this.setVisible(false);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modificador(usuarioActual,med1,noRefrigerados,refrigerados).setVisible(true);
            }
        });
    }
