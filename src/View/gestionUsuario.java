...
public class gestionUsuario extends javax.swing.JFrame {
     ...
     */
    public gestionUsuario(Usuario usuarioActual, String mensaje, Map<String,MedicamentoNoRefrigerado> noRefrigerados,Map<String,MedicamentoRefrigerado> refrigerados) {
        initComponents();
        tituloLabel.setText(mensaje);
        this.usuarioActual = usuarioActual;
        usuarios = new LinkedHashMap<>();
        controller = new ControllerUser(this,nombreTxt,apellidoTxt,userTxt,passTxt,usuarios,usuarioActual);
        ...
        apellidoTxt.setText(usuarioActual.getApellido());
        userTxt.setText(usuarioActual.getUsuario());
        passTxt.setText(usuarioActual.getContraseña());        
    }
    ...
    private void initComponents() {
        ...
        botonEliminar.setBackground(new java.awt.Color(255, 153, 204));
        ...
        entrarLabel1.setFont(new java.awt.Font("Roboto Black", 0, 12)); // NOI18N
        entrarLabel1.setForeground(new java.awt.Color(255, 255, 255));
        entrarLabel1.setText("ELIMINAR");
    ...
    private void botonVolverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonVolverMouseClicked
        MainMenu menu = new MainMenu(usuarioActual,noRefrigerados,refrigerados);
        menu.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_botonVolverMouseClicked

    private void botonGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonGuardarMouseClicked
        boolean bol = controller.validarModificacion();
        System.out.println(bol);
        if(bol){
            if(usuarioActual.isAcceso()){
                JOptionPane.showMessageDialog(null, "Modificacion Guardada, espere un momento...");
                controller.guardarModificacion();
    ...
    private void botonEliminarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonEliminarMouseExited
        botonEliminar.setBackground(new Color(255, 153, 204));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gestionUsuario(usuario,"",noRefrigerados,refrigerados).setVisible(true);
            }
        });
    }
