...
public class Gestor extends javax.swing.JFrame {
     ...
     */
    public Gestor(Usuario usuarioActual, Map<String,MedicamentoNoRefrigerado> noRefrigerados,Map<String,MedicamentoRefrigerado> refrigerados) {
        initComponents();
    ...
    private void gestionarButtomMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gestionarButtomMouseClicked
        crearMedicamento menu = new crearMedicamento(usuarioActual,noRefrigerados,refrigerados);
...
//        ModificarMedicamento menu = new ModificarMedicamento(usuarioActual,noRefrigerados,refrigerados);
//        menu.setVisible(true);
//        this.setVisible(false);
    ...
    private void gestionarButtom2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gestionarButtom2MouseClicked
        EliminarMedicamento menu = new EliminarMedicamento(usuarioActual,noRefrigerados,refrigerados);
        menu.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestor(usuarioActual,noRefrigerados,refrigerados).setVisible(true);
            }
        });
    }
