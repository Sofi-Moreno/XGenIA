...
public class Carrito extends javax.swing.JFrame {
     ...
     */
    public Carrito(Usuario usuarioActual,Map<String,MedicamentoNoRefrigerado> noRefrigerados,Map<String,MedicamentoRefrigerado> refrigerados,Map<String,Compra> listaCompra) {
        initComponents();
        ...
        controller = new ControllerCompra(this,precio,table,this.noRefrigerados,this.refrigerados,this.listaCompra);
        controller.tablaCompra();
        controller.calcularPrecio();
    }
    ...
    private void VolverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VolverMouseClicked
        ComprarMenu ventana = new ComprarMenu(usuarioActual,noRefrigerados,refrigerados,listaCompra);
    ...
    private void ingresarButtomMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ingresarButtomMouseClicked
        JOptionPane.showMessageDialog(null, "Su compra se ha realizado con exito.", "AVISO", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        Map<String,Compra> listaCompra = null;
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Carrito(usuarioActual,noRefrigerados,refrigerados,listaCompra).setVisible(true);
            }
        });
    }
