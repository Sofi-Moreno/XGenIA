...
-- Volcando datos para la tabla x-genia.trabajadores: ~5 rows (aproximadamente)
DELETE FROM `trabajadores`;
INSERT INTO `trabajadores` (`Apellido`, `Nombre`, `Usuario`, `Contraseña`) VALUES
	('Millan', 'Aquiles', 'amillan', '098765'),
	('Vivas', 'Guadalupe', 'gsvivas', '09876'),
	('Antias', 'Manuel', 'Massamanu', 'massa'),
	('Barrios', 'Ricardo', 'rabarrios', '12345'),
	('Moreno', 'Sofia', 'sgmoreno23', 'sofiguada');
